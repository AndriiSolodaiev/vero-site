...
projectLocation.fromTo(
  '.project-location__img-wrap img',
  {
    yPercent: -10,
    scale: 1.1,
    ease: 'none',
...
gsap.fromTo(
  '.project-location__right-card>svg',
  { rotate: 2, scale: 1, transformOrigin: 'center bottom' },
  {
    rotate: 6,
    scale: 1,
    ease: 'none',
...
gsap.fromTo(
  '.project-eco .block-description>svg',
  {
    rotate: -2,
    scale: 1,
